<?php
    ...
    $contents = @file_get_contents("https://news.google.com/news?cf=all&as_qdr=m&hl=uk&pz=1&ned=ua_ua&geo={$geo}&output=rss", false, $context);
    //https://news.google.com/news/section?cf=all&hl=ua&ned=uk_ua&geo=
    if ($contents === false)
    {
